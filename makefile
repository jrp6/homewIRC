...
SOURCES_SERVER = server/main.c server/accept_cb.c server/connection.c server/serverRead_cb.c server/transmitPrivmsg.c server/broadcastMsg.c server/sendWelcome.c server/doJoin.c server/close_on_error_eof_remove_conn.c

...
SOURCES_COMMON = common/echo_cb.c common/close_on_error_eof_cb.c common/logMessage.c common/message.c
SOURCES_CLIENT = client/main.c client/nick_on_connect_cb.c
